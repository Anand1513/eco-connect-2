                ...
                <div className="mt-8 mb-6">
                  <div className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto">
                    <img
                      ...
                      alt="Restaurants list surplus food"
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all hover:-translate-y-2">
                ...
                <div className="mt-8 mb-6">
                  <div className="w-20 h-20 bg-secondary/10 rounded-2xl flex items-center justify-center mx-auto">
                    <img
                      src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f514.svg"
                      alt="Notifications for NGOs and volunteers"
                      className="w-10 h-10 object-contain"
                    />
                  </div>
                </div>
                ...
                <div className="mt-8 mb-6">
                  <div className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto">
                    <img
                      ...
                      alt="Food collection and distribution"
                      className="w-10 h-10 object-contain"
                    />
                  </div>
                </div>
